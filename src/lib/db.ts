...
const isPostgresEnabled = isVercel || !!process.env.POSTGRES_URL || !!process.env.DATABASE_URL || !!process.env.storage_DATABASE_URL;
...
if (isPostgresEnabled && !process.env.POSTGRES_URL) {
  process.env.POSTGRES_URL = process.env.storage_DATABASE_URL || process.env.DATABASE_URL || '';
}
